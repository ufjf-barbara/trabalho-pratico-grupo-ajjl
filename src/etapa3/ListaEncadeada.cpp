...
vector<Artista> ListaEncadeada::getAll(string arq2) { // Cria vetor de artistas 
...
vector<Artista> ListaEncadeada::getAleatorios(int tam, string arq2) { // Cria vetor de N artistas aleatorios
    vector<Artista> lista; // Lista que recebera dados de artists.bin
